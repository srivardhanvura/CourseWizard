...
public class Course {
    ...
    public Course(String title, String description, String location, String timings, String status, String department, String code, int credits, int totalStrength, int currentStrength) {
        this.title = title;
